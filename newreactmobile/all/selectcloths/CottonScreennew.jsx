...
const CottonScreennew=()=> {
    ...
    useEffect(() => { //will render the page firs, then loads whats inside
        ...
        axios.get(`${BASE_URL}/imagesCotton/listCotton`) //slt
            .then((output) => {
    ...
    const handleImage = (id) => {
        ...
        axios.get(`${BASE_URL}/imagesCotton/${id}`) //slt
        .then((output) => {
                 if (output.data) { 
                ...
                navigateTo.navigate('SizeRec', { itemid:itemid, price: price, stock: stock, screenName: 'CottonScreennew' }); 
            }
        })
        .catch((error) => {
